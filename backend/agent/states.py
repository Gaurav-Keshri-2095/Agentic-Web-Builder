...
# These schemas help validate and organize data when an AI agent plans and implements an application.
# Field → Adds metadata such as descriptions and default values.
...
class FileItem(BaseModel):
    ...
    content: str = Field(description="Complete working code for the file")
...
class CoderState(BaseModel):
    ...
    generated_files: list[dict[str, str]] = Field(default_factory=list, description="Files generated in memory")